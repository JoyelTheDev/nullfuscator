...
public final class BogusJumpTransformer implements Transformer {
    ...
    public String description() {
        return "bogus GOTO indirection + junk islands";
    }
            ...
            for (MethodNode mn : cn.methods) {
                ...
                for (int i = 0; i < take; i++) {
                    ...
                    if (rnd.nextBoolean()) {
                        ...
                        frag.add(new MethodInsnNode(INVOKESTATIC,
                                "java/lang/System", "currentTimeMillis", "()J", false));
                        frag.add(new InsnNode(L2I));
                        frag.add(new MethodInsnNode(INVOKESTATIC,
                        ...
                        frag.add(new InsnNode(IOR));
                        pushInt(frag, selectedBit);
                        frag.add(new InsnNode(IAND));
                        frag.add(new JumpInsnNode(IFEQ, island));
                    }
